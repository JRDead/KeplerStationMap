...
/datum/map_template/shuttle/cargo/fulp/kepler // Keplerstation
	suffix = "kepler"
	name = "supply shuttle (Kepler)"
...
/datum/map_template/shuttle/arrival/fulp/kepler
	suffix = "kepler"
	name = "arrival shuttle (Kepler)"
...
/datum/map_template/shuttle/emergency/fulp/kepler
	suffix = "kepler"
	name = "Kepler Station Emergency Shuttle"
	credit_cost = CARGO_CRATE_VALUE * 4
	description = "A mid-sized shuttle with all the essentials for survival. It includes a bar and an exclusive luxury area."
	occupancy_limit = "50"
